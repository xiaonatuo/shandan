...
public class ViewAggregationTask extends ViewAggregation {
    private static final String alias = "task_histogram";
    private static final ViewType type = ViewType.task;

    public ViewAggregationTask(SearchRequest request, RestHighLevelClient client) {
