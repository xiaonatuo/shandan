...
alter table "BIANMU"."OAUTH_CLIENT_DETAILS" add TITLE varchar2(30);
alter table "BIANMU"."OAUTH_CLIENT_DETAILS" add TARGET varchar2(10);
alter table "BIANMU"."OAUTH_CLIENT_DETAILS" add ICON varchar2(100);
alter table "BIANMU"."OAUTH_CLIENT_DETAILS" add SORT INTEGER;

COMMENT ON COLUMN "BIANMU"."OAUTH_CLIENT_DETAILS"."SORT" IS '应用排列顺序';
COMMENT ON COLUMN "BIANMU"."OAUTH_CLIENT_DETAILS"."TARGET" IS '应用打开方式';
COMMENT ON COLUMN "BIANMU"."OAUTH_CLIENT_DETAILS"."TITLE" IS '应用标题';
COMMENT ON COLUMN "BIANMU"."OAUTH_CLIENT_DETAILS"."ICON" IS '应用图标';

INSERT INTO BIANMU.SYS_DICT_TYPE (ID, NAME, CREATE_USER, CREATE_TIME, MODIFY_USER, MODIFY_TIME) VALUES ('PUBLIC_SETTING', '系统公共配置', 'sa', '2021-12-27 17:41:02.372000', 'sa', '2021-12-27 17:41:02.389000');
INSERT INTO BIANMU.SYS_DICT (ID, DICT_CODE, TYPE_ID, DICT_NAME, DICT_VALUE, DICT_DESC, DICT_ORDER, DICT_STATE, CREATE_USER, CREATE_TIME, MODIFY_USER, MODIFY_TIME) VALUES ('1475401958026567681', 'OFFICE_ONLINE_SERVER', 'PUBLIC_SETTING', 'office在线预览服务地址', 'http://127.0.0.1:8012/onlinePreview', 'office在线预览服务地址', 1, true, 'sa', '2021-12-27 17:43:33.107000', 'sa', '2021-12-27 17:43:33.107000');

alter table "BIANMU"."SYS_NOTIFICATION" add OPINION varchar2(500);
alter table "BIANMU"."SYS_NOTIFICATION" add CN_NAME varchar2(20);

COMMENT ON COLUMN "BIANMU"."SYS_NOTIFICATION"."OPINION" IS '审批意见';
COMMENT ON COLUMN "BIANMU"."SYS_NOTIFICATION"."CN_NAME" IS '系统名称';

alter table "BIANMU"."SYS_NOTIFICATION_UNREAD" add OPINION varchar2(500);
alter table "BIANMU"."SYS_NOTIFICATION_UNREAD" add CN_NAME varchar2(20);

COMMENT ON COLUMN "BIANMU"."SYS_NOTIFICATION_UNREAD"."OPINION" IS '审批意见';
COMMENT ON COLUMN "BIANMU"."SYS_NOTIFICATION_UNREAD"."CN_NAME" IS '系统名称';